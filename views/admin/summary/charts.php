...
<div id="primary">
	...
	<section class="ten columns alpha omega">
		<div class="panel">
			...
			<canvas id="hitsLast30DaysChart" class="graph-canvas"></canvas>
	...
	<section class="ten columns alpha omega">
		<div class="panel">
			...
			<canvas id="hitsLast12MonthsChart" class="graph-canvas"></canvas>
	...
	<section class="ten columns alpha omega">
		<div class="panel">
			...
			<canvas id="hitsPerYearChart" class="graph-canvas"></canvas>
	...
	<section class="ten columns alpha omega">
		<div class="panel">
			...
			<canvas id="acceptLanguageChart" class="graph-canvas"></canvas>
	...
	<?php fire_plugin_hook('stats_summary_graphs', array('view' => $this)); ?>
</div>
